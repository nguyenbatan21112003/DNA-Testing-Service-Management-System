  ...
  return (
    <div style={{ padding: 0 }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 24 }}>
        <h1
          style={{ fontSize: 28, fontWeight: 700, color: "#722ed1", margin: 0 }}
        >
          Báo cáo & Thống kê
        </h1>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: "#fff" }}>Tổng đơn hàng</span>}
        ...
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: "#fff" }}>Tỷ lệ đúng hạn</span>}
        ...
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            <Statistic
              title={<span style={{ color: "#fff" }}>Hài lòng KH</span>}
              value={reportData.customerSatisfaction + "/5"}
              prefix={<SmileOutlined />}
              valueStyle={{ color: "#fff" }}
            />
          </Card>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: 32 }}>
        <Col xs={24} lg={16}>
          <Card
            title={<span style={{ color: "#722ed1" }}>Xu hướng 12 tháng</span>}
          >
            <div
              style={{
                height: 250,
        ...
        <Col xs={24} lg={8}>
          <Card
            title={<span style={{ color: "#1890ff" }}>Phân bố dịch vụ</span>}
          >
