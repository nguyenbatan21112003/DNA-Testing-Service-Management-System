    ...
    if ((!user || user.role_id !== 2) && existingOrders.length === 0) {
      ...
      const sampleOrders = [
        ...
        },
        {
          ...
          kitStatus: "da_nhan",
          kitId: "KIT-PC-1003",
          result: "Kết quả xét nghiệm cho thấy mối quan hệ cha con với độ chính xác 99.99%",
          priority: "Cao",
          sampleInfo: {
            id: "XN-123456",
        ...
        },
        {
          ...
          date: "08/06/2024",
          sampleMethod: "center",
          result: "Kết quả xét nghiệm loại trừ mối quan hệ cha con với độ chính xác 100%",
          priority: "Trung bình",
        },
        {
          id: 1007,
    ...
    <StaffDashboardContext.Provider value={{ setActiveTab }}>
      <Layout style={{ minHeight: "100vh" }}>
        ...
        <Layout style={{ marginLeft: collapsed ? 80 : 240 }}>
          ...
          <Content style={{ margin: 0, padding: 0, minHeight: "100vh", background: "#f5f5f5" }}>
            {renderContent()}
          </Content>
        </Layout>
      </Layout>
