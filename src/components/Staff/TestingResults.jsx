        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="small">
                    ...
                    <Button size="small" icon={<EditOutlined />} onClick={() => handleEditResult(record)}>
                        Nhập kết quả
                    </Button>
                    {record.result && (
                ...
                {selectedOrder && (
                    <div style={{ background: "#fff", padding: 24, border: "1px solid #ddd" }}>
                        <div style={{ textAlign: "center", marginBottom: 24 }}>
                            <Title level={4}>TRUNG TÂM XÉT NGHIỆM ADN DNA LAB</Title>
                            <Text>132 Hoàng Văn Thụ, Phường Phương Sài, Nha Trang</Text>
