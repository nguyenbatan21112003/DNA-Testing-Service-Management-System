...
const TestAppManagement = ({
  ...
  const getDisplayStatus = (order) =>
    order.status || order.samplingStatus || order.kitStatus || "PENDING_CONFIRM";
          ...
          {(() => {
            const filteredOrders = userOrders
              ...
              .filter(
                (o) =>
                  searchOrder.trim() === "" ||
                  o.id.toLowerCase().includes(searchOrder.trim().toLowerCase()) ||
                  (o.type &&
                    o.type
                      .toLowerCase()
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ color: "#888", fontSize: 15, marginBottom: 8 }}>
                      <b>Địa điểm thu mẫu:</b> {getSampleMethodLabel(order.sampleMethod)}
                    </div>
                    <div style={{ color: "#888", fontSize: 15, marginBottom: 8 }}>
                      <b>Số người xét nghiệm:</b> {order.numPeople || (Array.isArray(order.members) ? order.members.length : "-")}
                    </div>
                    <div style={{ color: "#888", fontSize: 15 }}>Ngày đăng ký: {order.date}</div>
                      ...
                      >
                        <span style={{ fontSize: 20, marginRight: 6 }}>
                          <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 2v2m10-2v2M3 10h18M5 6h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2Z" stroke="#1d4ed8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </span>
